...
import {useCreateLoadForm} from "./useCreateLoadForm";
...
export const CreateLoadForm = () => {
    const {onSubmit, register, handleSubmit, control, isLoading, errors} =
        useCreateLoadForm();

    const {loadFormFields, loadSchemaGroups} = useGetLoadMetaData();

    const textAndNumberFields = loadFormFields.filter(
        (formField) => formField.type === "text" || formField.type === "number"
    );
    const selectAndCheckboxFields = loadFormFields.filter(
        ...
        <>
            {!isLoading && (
                <div className="content">
                    ...
                    {/*        <Card>*/}
                    {/*          <CardHeader>*/}
                    {/*            <CardTitle tag="h4">Create Load</CardTitle>*/}
                    {/*          </CardHeader>*/}
                    {/*          <CardBody>*/}
                    ...
                    <CreateEntityForm
                        entityName={"Load"}
                        formFields={loadFormFields}
                        schemaGroups={loadSchemaGroups}
                        onSubmit={onSubmit}
                        register={register}
